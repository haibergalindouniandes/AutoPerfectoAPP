...
class Vista_lista_autos(QWidget):
    ...
    def __init__(self, interfaz):
        ...
        self.setStyleSheet(self.constante.COLOR_INTERFAZ + self.constante.COLOR_TEXTO)
    ...
    def inicializar_GUI(self):
        ...
        self.btn_aniadir_auto.setStyleSheet("border :1px solid black;")
        ...
        # setting up the border
        self.btn_ver_mantenimientos.setStyleSheet("border :1px solid black;")
    ...
    def mostrar_autos(self, lista_autos):
        ...
        if (self.autos!= None and len(self.autos)>0) :
            ...
            for dic_auto in self.autos:
                ...
                # setting up the border
                btn_ver_actividad.setStyleSheet("border :1px solid black;")
                btn_ver_actividad.setFixedSize(30,30)
                ...
                btn_ver_actividad.clicked.connect(partial(self.mostrar_auto,dic_auto['placa']) )
                ...
                # setting up the border
                btn_editar.setStyleSheet("border :1px solid black;")
                ...
                # setting up the border
                btn_terminar.setStyleSheet("border :1px solid black;")
                btn_terminar.setFixedSize(30,30)
                ...
                # setting up the border
                btn_eliminar.setStyleSheet("border :1px solid black;")
    ...
    def mostrar_ventana_crear_auto(self):
        ...
        """
        print('************** Método mostrar_ventana_crear_auto **************')
        self.auto_actual = -1
        self.hide()
        print('self.auto_actual --> ' + str(self.auto_actual))
    ...
    def eliminar_auto(self,indice_auto):
        ...
        mensaje_confirmacion.setStyleSheet(self.constante.COLOR_INTERFAZ + self.constante.COLOR_TEXTO)
    ...
    def error_vender_auto(self):
            ...
            mensaje_error.setStyleSheet(self.constante.COLOR_INTERFAZ + self.constante.COLOR_TEXTO)
    ...
    def error_vender_auto_acciones(self):
            mensaje_error=QMessageBox()
            mensaje_error.setStyleSheet(self.constante.COLOR_INTERFAZ + self.constante.COLOR_TEXTO)
            mensaje_error.setIcon(QMessageBox.Critical)
            mensaje_error.setText("No se pudo realizar la venta del automóvil ya que tiene acciones de mantenimiento registradas\nPor favor verifique e intente nuevamente.")        
            mensaje_error.setWindowTitle("Error al vender el automóvil")
            mensaje_error.setWindowIcon(QIcon("src/recursos/smallLogo.png"))
            mensaje_error.setStandardButtons(QMessageBox.Ok ) 
            respuesta=mensaje_error.exec_()

    def error_crear_auto_existente(self):
            mensaje_error=QMessageBox()
            mensaje_error.setStyleSheet(self.constante.COLOR_INTERFAZ + self.constante.COLOR_TEXTO)
            mensaje_error.setIcon(QMessageBox.Critical)
            mensaje_error.setText("La placa del automóvil ya se encuentra registrada\nPor favor verifique e intente nuevamente.")        
            mensaje_error.setWindowTitle("Error al registrar el automóvil")
            mensaje_error.setWindowIcon(QIcon("src/recursos/smallLogo.png"))
            mensaje_error.setStandardButtons(QMessageBox.Ok ) 
            respuesta=mensaje_error.exec_()            
            
    def error_editar_auto_no_existe(self):
            mensaje_error=QMessageBox()
            mensaje_error.setStyleSheet(self.constante.COLOR_INTERFAZ + self.constante.COLOR_TEXTO)
            mensaje_error.setIcon(QMessageBox.Critical)
            mensaje_error.setText("La placa del automóvil no se encuentra registrada\nPor favor verifique e intente nuevamente.")        
            mensaje_error.setWindowTitle("Error al registrar el automóvil")
            mensaje_error.setWindowIcon(QIcon("src/recursos/smallLogo.png"))
            mensaje_error.setStandardButtons(QMessageBox.Ok ) 
            respuesta=mensaje_error.exec_()              