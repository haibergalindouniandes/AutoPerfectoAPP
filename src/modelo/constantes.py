...
class Constantes(object):
    ...
    CONSULTA_ACCIONES_POR_AUTOMOVIL = "SELECT a.id, a.kilometraje, a.valor, a.fecha, m.nombre AS mantenimiento FROM accion a INNER JOIN mantenimiento m ON a.mantenimiento_id = m.id  WHERE a.automovil_id = {auto_id} ORDER BY a.fecha DESC"
    ...
    # Constantes para el diseño de la interfaz grafica
    COLOR_INTERFAZ = "background-color: rgb(61,61,61); "
    COLOR_TEXTO = "color: rgb(255,255,255); "
